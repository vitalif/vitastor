...
RUN dnf -y install gcc-c++ gperftools-devel fio nodejs rpm-build jerasure-devel isa-l-devel libisa-l_crypto-devel gf-complete-devel rdma-core-devel cmake libnl3-devel c-ares-devel
