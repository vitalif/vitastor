...
static const char* help_text =
    ...
    "  -l|--long       Also report allocated size, creation time and I/O statistics\n"
    "  --del           Also include delete operation statistics\n"
    "  --sort FIELD    Sort by specified field (name, size, create_ts, used_size, <read|write|delete>_<iops|bps|lat|queue>)\n"
